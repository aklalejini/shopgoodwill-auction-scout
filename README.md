...
Auction Scout is a free, image-first feed for finding overlooked ShopGoodwill auctions across configurable categories. Its current hunts cover **Minerals & Geology**, **Sealed Vintage Media**, and **Vintage Electron Tubes**, with independent search and scoring logic for each.
